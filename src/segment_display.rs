...
/// Macro around `configure_pin` to further reduce boilerplate when configuring pins.
...
pub struct SegmentDisplay {
    ...
    segments: [SegmentPin; Self::SEGMENT_COUNT],
    decimal: SegmentPin,
}
impl SegmentDisplay {
    ...
    pub fn new(pins: [SegmentPin; Self::SEGMENT_COUNT + 1]) -> Self {
    ...
    pub fn show_digit(&mut self, digit: u8) {
        ...
        let pins: [bool; Self::SEGMENT_COUNT] = match digit % 10 {
